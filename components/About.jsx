      ...
      <div className="container">
        ...
        >
          ...
          <p className="max-w-[900px] text-right p-3 bg-white relative text-lg">
            نحن منصة محادثة ودردشة حية ومباشرة لتبادل المعلومات و الآراء بين
            المتداولين والمضاربين في سوق الأسهم السعودي (تداول) ونوفر أيضا نظام
            للتصويت على أداء المؤشر يوميا مع امكانية نشر التصويت في تويتر.
            الإنضمام الى المحادثة لا يتطلب حساب شخصي. كما ان الموقع لا يتبنى أي
            رأي او اقتراح او توصية ويخلي مسؤوليته من أي ضرر ناتج من المحادثات
